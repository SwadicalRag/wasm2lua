...
class IROpGetGlobal extends IROperation {
    ...
    constructor(parent: IRControlBlock, private index, public type: IRType) {
        super(parent);
    }
...
class IROpReadMemory extends IROperation {
    constructor(parent: IRControlBlock, private wasm_type: Valtype, private offset: number, private source_width?: number, private signed = false) {
        super(parent);
            ...
            if (instr.id == "br") {
                ...
                switch (instr.id) {
                    ...
                    case "get_global":
                        ...
                        let global_index = (instr.args[0] as NumberLiteral).value;
